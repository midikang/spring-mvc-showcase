...
@Controller
@RequestMapping("/midi/form")
@SessionAttributes("shipment")
public class MidiFormController {
	...
	public String processSubmit(@Valid Shipment shipment, BindingResult result,
		...
		String message = "Form submitted successfully. Bond " + shipment;
